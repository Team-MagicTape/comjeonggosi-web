      ...
      <div className="gap-6 mb-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        <div className="w-full h-full bg-white rounded-[16px] p-7">
          ...
          <div className="text-[#666] text-[14px] line-clamp-2 overflow-hidden mb-[13px]">
            127.0.0.1은 루프백(Loopback) 주소라고 불려요. 자기 자신을 가리키는
            IP 주소예요. 즉, 네트워크를 타지 않고 자기 컴퓨터 내부에서만 통신할
            때 사용해요.
          </div>
          ...
          <div className="line-clamp-2 text-[#333]">
            127.0.0.1은 루프백(Loopback) 주소로, 자신의 컴퓨터를 의미한다. 보통
            localhost와 동일하게 쓰이며, 외부 네트워크와 통신하지 않고 자기
            자신과의 통신을 위해 사용된다
          </div>
        </div>
        <div className="w-full h-full bg-white rounded-[16px] p-7">
