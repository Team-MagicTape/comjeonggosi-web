...
const MainQuiz = () => {
  return (
    <div className="w-full bg-white border border-border rounded-2xl p-4 xl:p-8 flex flex-col gap-4">
      ...
      <CustomLink href="/quizzes" className="mx-auto bg-primary text-white px-6 py-2 text-lg font-medium rounded-item flex items-center gap-1 mt-2 cursor-pointer">
        <p>퀴즈 풀러가기</p>
        <ArrowRight size={20} />
      </CustomLink>
    </div>
